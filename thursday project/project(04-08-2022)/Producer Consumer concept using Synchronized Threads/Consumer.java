...
{
	Problem Shop;
     int number, value=0,i,n=10; // globally declared the value
     Consumer(Problem c, int number)  // parametrized constructor of consumer class
     {
           Shop = c;
           this.number = number;
     } 
    ...
    {
          for (i = 0; i < n; i++) //for loop execute for printing the value
          {
                value = Shop.get(); // the value get 
